...
// using priority queue (min-heap) to store the vertices based on their tentative distances from the source vertex
...
//using set to store the vertices based on their tentative distances from the source vertex
